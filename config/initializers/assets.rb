...
Rails.application.config.assets.precompile += %w( stimulus.min.js stimulus-loading.js bootstrap.js popper.js js/sortable.js pdf.css number_pages.js jquery.min.js jquery_ujs.js jquery-ui.min.js timeline.min.js )
