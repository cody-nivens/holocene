...
In 1815, the Tambora volcano<indexterm><primary>Eruption</primary></indexterm> exploded resulting in a global winter within 'recorded' history<footnote><para><emphasis>Volcano Weather: the story of 1816, the year without a summer</emphasis></para></footnote>.  
...
<section>
<title>304 - 306 AD: Famines and Epidemics</title>
<para>Empire wide<indexterm><primary>Famine</primary></indexterm>.
Stathakopoulos states that the statement that the living were outnumbered by the dead is topoi as far as records go, but many have a basis in fact.  
Consider that the Plague of Cyprian was smallpox and when introduced to new areas would have a potential decimating effect(29).</para>
</section>
<section>
...
The plagues of Antonine<footnote><para>165 - 189 AD</para></footnote> and Cyprian<footnote><para>251 - 270 AD</para></footnote> where the result of the introduction of Smallpox into the Roman army on the borders of the empire resulting in the spread of the disease into the heart land of Rome.  
...
Typhus<indexterm><primary>Epidemic</primary><secondary>Typhus</secondary></indexterm><indexterm><primary>Typhus</primary></indexterm> made an appearance as the Plague of Athens becoming the second appearance in recorded Greek history.  
...
effects on animals other than rats and man is complex.  
...
Black footed ferrets can also carry the plague fleas without harm.
<footnote><para>Yellow fever, black goddess</para></footnote></para>
<section>
<title>Typhus</title>
<para>Spread by lice.  Rodents have lice which carry typhus.  
When the rodent is in close quarters with people, the disease is spread via the rodent lice turning to humans when the rodents die from the disease.
</para><para>
The rodent lice infect the human lice and the person sickens as a result.</para>
<section>
...
The Waste Lands of Arthur legions started here with area totally emptied of population and others reflecting the shrunken survivors(1).
</para><para>
...
<section>
<title>1500 BC: First Occurrence(16)</title>
...
<section>
<title>Final collapse of the Roman Empire</title>
</section>
<section>
<title>1347 - 1350's AD: Third Occurrence(38)</title>
</section>
<section>
<title>Plague vs. Famine</title>
<para>The after effects of Plagues and Famines <indexterm><primary>Famine</primary></indexterm>differ in who dies during such an event.  
