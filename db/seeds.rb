...
:slug => "W2kK8enbLb",
:book => @book,
:body => "<p>My first and primary occupation in life has been Computer Science.  From beginning with Basic on a Woods[[zZcEzBnHkH]] computer and the December 1973 Popular Science magazine's article on the Intel 8080 microprocessor chip to today's cloud environment, Computer Science and its practice has allowed me to sharpen my skills at pattern recognition.  
</p><p>
...
In the Amazon, there are archaeological digs going on documenting the settlements abandoned 500 years ago[[dVQuBcytzQ]].   
...
[[ZcdpSuzaj3]]</p><p>
This pattern of epidemics on a native[[9eHTxSTHfs]] population can possibly be used to explain the mystery of the Minion's disappearance from history as well as the interesting fact that an epidemic of 1,500BC left its mark on the gene pool of Europe[[Pw0XF5gWHF]].
</p><p>
...
section_index = 0
biblio = nil
Footnote.create(:slug => "zZcEzBnHkH", :body => "Pencil and paper", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
biblio = nil
Footnote.create(:slug => "dVQuBcytzQ", :body => "Amazon archaeology of 1500 settlements", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
biblio = nil
Footnote.create(:slug => "ZcdpSuzaj3", :body => "I remember that during the Swine flu the early 1970's, my father was struck with flu and pneumonia.", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
biblio = nil
Footnote.create(:slug => "9eHTxSTHfs", :body => "Exposure of 'lost' tribes to diseases", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
biblio = nil
Footnote.create(:slug => "Pw0XF5gWHF", :body => "Gene study which lead to discovery of European plague in 1500BC", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
...
section_index += 1
biblio = nil
Footnote.create(:slug => "AM2nzVkjpq", :body => "Arizona University website", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
...
:body => "<p>Bond events
 ...
 are events which have occurred in the climate of the earth on a regularly reoccurring basis of about 1470 years.  They are observed in sediments that come from changes in the ice flows in the Arctic.[[CBygUNy8sF]]</p>",
:slug => "prNdy55QF6",
:position => section_index,
:display_name => true,
:chapter_id => @chapter.id
...
section_index += 1
biblio = nil
Footnote.create(:slug => "CBygUNy8sF", :body => "http://rivernet.ncsu.edu/courselocker/PaleoClimate/Bond et al., 1997 Millenial Scale Holocene Change.pdf", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
...
In 1815, the Tambora volcano exploded resulting in a global winter within 'recorded' history.[[9V1rh3EGKS]]
...
Footnote.create(:slug => "9V1rh3EGKS", :body => "Volcano Weather: the story of 1816, the year without a summer", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
result = Section.create({:name => "Definition",
:body => "<p>A Global winter is a climate event which encompasses the whole planet[[ezUrpLW0Q4]].
...
Footnote.create(:slug => "ezUrpLW0Q4", :body => "Volcanic Dry Fogs, Climate Cooling, and Plague Pandemics in Europe and the Middle East", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
...
The plagues of Antonine[[ft7kUzfd8U]]  and Cyprian[[TDEmRa3tjQ]] were the result of the introduction of Smallpox into the Roman army on the borders of the empire resulting in the spread of the disease into the heart land of Rome.
It is believed that both of these epidemic were Smallpox because tests on the measles virus lead some to believe that it did not evolve into it present form until around 1,000 AD[[8K2jv1GRna]].
</p><p>
...
If the 'Winter' is severe enough, plague rears out of Africa traveling along the eastern coast to the Red sea and it connection to the Mediterranean[[6aMK1nyRg5]].
</p><p>
During the Little Ice Age (1300-1850), the Black  Death was not the only plague to hit Europe[[5RXbLCj4vN]].
</p><p>
...
Sent by Apollo via his 'army' of mice[[sYcLpem3jq]].
</p><p>
...
Black footed ferrets can also carry the plague fleas without harm[[qQCVENwYVY]].
</p>",
:slug => "ETahBtP0Qw",
:position => section_index,
:display_name => true,
...
section_index += 1
biblio = nil
Footnote.create(:slug => "ft7kUzfd8U", :body => "165 - 189 AD", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
biblio = nil
Footnote.create(:slug => "TDEmRa3tjQ", :body => "251 - 270 AD", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
biblio = nil
Footnote.create(:slug => "8K2jv1GRna", :body => "Wiki reference", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
biblio = Biblioentry.find_by_xreflabel("rosen2007")
Footnote.create(:slug => "6aMK1nyRg5", :body => "Justinian's Flea", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
biblio = Biblioentry.find_by_xreflabel("zinsser1935")
Footnote.create(:slug => "5RXbLCj4vN", :body => "Rats, Lice and History", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
biblio = Biblioentry.find_by_xreflabel("homer800BC")
Footnote.create(:slug => "sYcLpem3jq", :body => "Illiad", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
biblio = Biblioentry.find_by_xreflabel("wills1996")
Footnote.create(:slug => "qQCVENwYVY", :body => "Yellow fever, black goddess", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '220px-Morasko_krater_zima.jpg')), filename: '220px-Morasko_krater_zima.jpg', content_type: 'image/20px-morasko_krater_zima.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Rio Caurto Craters ", :start_year => -3000)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-lvinaya_past_20070718011232.jpg')), filename: '280px-lvinaya_past_20070718011232.jpg', content_type: 'image/80px-lvinaya_past_20070718011232.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Sakurajima55.jpg')), filename: '280px-Sakurajima55.jpg', content_type: 'image/80px-sakurajima55.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Pinatubo91eruption_clark_air_base.jpg')), filename: '280px-Pinatubo91eruption_clark_air_base.jpg', content_type: 'image/80px-pinatubo91eruption_clark_air_base.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', 'Novarupta.jpg')), filename: 'Novarupta.jpg', content_type: 'image/ovarupta.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Santa Maria VEI 6 ", :start_year => 1902)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Santiaguito_from_Santamaria.jpg')), filename: '280px-Santiaguito_from_Santamaria.jpg', content_type: 'image/80px-santiaguito_from_santamaria.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Krakatau, Indonesia VEI 6", :start_year => 1883)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Krakatoa_eruption_lithograph.jpg')), filename: '280px-Krakatoa_eruption_lithograph.jpg', content_type: 'image/80px-krakatoa_eruption_lithograph.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
Confirmed Eruption
Historical Observations
</p><p>This was the first eruption within 'written' history that had the benefit of an extensive amount of information gathered by a wide range of individuals.  The Stommel's in their book[[3JB28jWvN4]] provide a very detailed account of the sequence of events in North America in 1816.  
</p><p>
...
Footnote.create(:slug => "", :body => "", :noted => result,:biblioentry_id => biblio.id)
biblio = Biblioentry.find_by_xreflabel("stommel1983")
Footnote.create(:slug => "3JB28jWvN4", :body => "Volcano Weather: the story of 1816, the year without a summer", :biblioentry_id => (biblio.nil? ? nil : biblio.id), :noted => result)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '220px-Huaynaputina.jpg')), filename: '220px-Huaynaputina.jpg', content_type: 'image/20px-huaynaputina.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-MtChurchill-KlutlanGlacier.jpg')), filename: '280px-MtChurchill-KlutlanGlacier.jpg', content_type: 'image/80px-mtchurchill-klutlanglacier.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Witori VEI 6 ", :start_year => 710)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '260px-STS008-36-1403_cropped_rotated.jpg')), filename: '260px-STS008-36-1403_cropped_rotated.jpg', content_type: 'image/60px-sts008-36-1403_cropped_rotated.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Dakataua VEI 6 ", :start_year => 653)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Aniakchak-caldera_alaska.jpg')), filename: '280px-Aniakchak-caldera_alaska.jpg', content_type: 'image/80px-aniakchak-caldera_alaska.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-MountVeniaminof.jpg')), filename: '280px-MountVeniaminof.jpg', content_type: 'image/80px-mountveniaminof.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-MSH82_st_helens_plume_from_harrys_ridge_05-19-82.jpg')), filename: '280px-MSH82_st_helens_plume_from_harrys_ridge_05-19-82.jpg', content_type: 'image/80px-msh82_st_helens_plume_from_harrys_ridge_05-19-82.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Cerro_hudson.jpg')), filename: '280px-Cerro_hudson.jpg', content_type: 'image/80px-cerro_hudson.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Black_Peak.jpg')), filename: '280px-Black_Peak.jpg', content_type: 'image/80px-black_peak.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Cerro_Blanco_volcano_(AVA_Granule_L1B_20000916145757).jpg')), filename: '280px-Cerro_Blanco_volcano_(AVA_Granule_L1B_20000916145757).jpg', content_type: 'image/80px-cerro_blanco_volcano_(ava_granule_l1b_20000916145757).jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Pinatubo, Philippines VEI 6", :start_year => -3550)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Taal_Volcano_aerial_2013.jpg')), filename: '280px-Taal_Volcano_aerial_2013.jpg', content_type: 'image/80px-taal_volcano_aerial_2013.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Ulawun_steam_plume.jpg')), filename: '280px-Ulawun_steam_plume.jpg', content_type: 'image/80px-ulawun_steam_plume.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Masaya, Nicaragua VEI 6 ", :start_year => -4050)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Volcan_Masaya2.jpg')), filename: '280px-Volcan_Masaya2.jpg', content_type: 'image/80px-volcan_masaya2.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Kikai Caldera, Ryukyu Islands (Japan) VEI 7", :start_year => -4350)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', 'Kikai_Caldera_Relief_Map,_SRTM,_English.jpg')), filename: 'Kikai_Caldera_Relief_Map,_SRTM,_English.jpg', content_type: 'image/ikai_caldera_relief_map,_srtm,_english.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '260px-Macauley_Island.png')), filename: '260px-Macauley_Island.png', content_type: 'image/60px-macauley_island.png')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', 'OnekotanIslandNASA.jpg')), filename: 'OnekotanIslandNASA.jpg', content_type: 'image/nekotanislandnasa.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '250px-Image-2008_Lake_Masshu.jpg')), filename: '250px-Image-2008_Lake_Masshu.jpg', content_type: 'image/50px-image-2008_lake_masshu.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '250px-Crater_Lake_winter_pano2.jpg')), filename: '250px-Crater_Lake_winter_pano2.jpg', content_type: 'image/50px-crater_lake_winter_pano2.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Khangar.jpg')), filename: '280px-Khangar.jpg', content_type: 'image/80px-khangar.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', 'Menengai_crater_view_from_the_edge.jpg')), filename: 'Menengai_crater_view_from_the_edge.jpg', content_type: 'image/enengai_crater_view_from_the_edge.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Akademia_nauk.jpg')), filename: '280px-Akademia_nauk.jpg', content_type: 'image/80px-akademia_nauk.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Fisher Caldera, Aleutian Islands  VEI 6", :start_year => -7420)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Sakura-jima_from_space.jpg')), filename: '280px-Sakura-jima_from_space.jpg', content_type: 'image/80px-sakura-jima_from_space.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Iceland_Grimsvoetn_1972-B.jpg')), filename: '280px-Iceland_Grimsvoetn_1972-B.jpg', content_type: 'image/80px-iceland_grimsvoetn_1972-b.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '260px-Ulleung_island_from_above.jpg')), filename: '260px-Ulleung_island_from_above.jpg', content_type: 'image/60px-ulleung_island_from_above.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Cotopaxi_volcano_2008-06-27T1322.jpg')), filename: '280px-Cotopaxi_volcano_2008-06-27T1322.jpg', content_type: 'image/80px-cotopaxi_volcano_2008-06-27t1322.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-Santorini_Caldera_Landsat.jpg')), filename: '280px-Santorini_Caldera_Landsat.jpg', content_type: 'image/80px-santorini_caldera_landsat.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '220px-Kaali-crater-saaremaa-estonia-aug-2007.jpg')), filename: '220px-Kaali-crater-saaremaa-estonia-aug-2007.jpg', content_type: 'image/20px-kaali-crater-saaremaa-estonia-aug-2007.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', 'Macha_craters_overview_map.jpg')), filename: 'Macha_craters_overview_map.jpg', content_type: 'image/acha_craters_overview_map.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Taupo, New Zealand VEI 6", :start_year => -1460)
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', 'MtBalbiToreNASA.jpg')), filename: 'MtBalbiToreNASA.jpg', content_type: 'image/tbalbitorenasa.jpg')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
biblio = Biblioentry.find_by_xreflabel("holoceneeruptions")
...
result.image.attach(io: File.open(Rails.root.join('codys_book', 'images', '280px-ShepherdIslandsMap.png')), filename: '280px-ShepherdIslandsMap.png', content_type: 'image/80px-shepherdislandsmap.png')
@timeline.holocene_events << result unless @timeline.holocene_events.include?(result)
@timeline_timeline.holocene_events << result unless @timeline_timeline.holocene_events.include?(result)
@object.holocene_events << result
