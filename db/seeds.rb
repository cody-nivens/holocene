...
result = Biblioentry.create({:name => "Olympia hypothesis: Tsunamis buried the cult site on the Peloponnese ",
  ...
  :releaseinfo => "<a href='http://www.uni-mainz.de/eng/14389.php'>Olympia hypothesis: Tsunamis buried the cult site on the Peloponnese
</a>",
  :user_id => @user.id,
  :publisher => ""
})
...
result = Biblioentry.create({:name => "Corpus of Electronic Texts: The Annals of Ulster",
  ...
  :releaseinfo => "<a href='http://www.ucc.ie/celt/published/t100001A/'>Corpus of Electronic Texts: The Annals of Ulster
</a>",
  :user_id => @user.id,
  :publisher => ""
})
...
:slug => "eHhHQWEQQm",
:book => @book,
:body => "<p>My first and primary occupation in life has been Computer Science.  From beginning with Basic on a Woods[[eHhHQWEQQm8Enpn984fD]] computer and the December 1973 Popular Science magazine's article on the Intel 8080 microprocessor chip to today's cloud environment, Computer Science and its practice has allowed me to sharpen my skills at pattern recognition.  
</p><p>
...
In the Amazon, there are archaeological digs going on documenting the settlements abandoned 500 years ago[[eHhHQWEQQmVdKJ2pDfM1]].   
...
[[eHhHQWEQQmqba3TktgQS]]</p><p>
This pattern of epidemics on a native[[eHhHQWEQQmZ1BSNEmkzT]] population can possibly be used to explain the mystery of the Minion's disappearance from history as well as the interesting fact that an epidemic of 1,500BC left its mark on the gene pool of Europe[[eHhHQWEQQm3wU857fBgQ]].
</p><p>
...
chapter_index += 1
section_index = 0
Footnote.create(:slug => "8Enpn984fD", :body => "Pencil and paper", :noted => result)
Footnote.create(:slug => "VdKJ2pDfM1", :body => "Amazon archaeology of 1500 settlements", :noted => result)
Footnote.create(:slug => "qba3TktgQS", :body => "I remember that during the Swine flu the early 1970's, my father was struck with flu and pneumonia.", :noted => result)
Footnote.create(:slug => "Z1BSNEmkzT", :body => "Exposure of 'lost' tribes to diseases", :noted => result)
Footnote.create(:slug => "3wU857fBgQ", :body => "Gene study which lead to discovery of European plague in 1500BC", :noted => result)
...
@object = result
section_index += 1
Footnote.create(:slug => "bntsLkPk1V", :body => "Arizona University website", :noted => result)
...
:body => "<p>Bond events
 ...
 are events which have occurred in the climate of the earth on a regularly reoccurring basis of about 1470 years.  They are observed in sediments that come from changes in the ice flows in the Arctic.[[xHb65pLMJbVWxqDZXMSw]]</p>",
:slug => "xHb65pLMJb",
:position => section_index,
:chapter_id => @chapter.id
})
@object = result
section_index += 1
Footnote.create(:slug => "VWxqDZXMSw", :body => "http://rivernet.ncsu.edu/courselocker/PaleoClimate/Bond et al., 1997 Millenial Scale Holocene Change.pdf", :noted => result)
...
In 1815, the Tambora volcano exploded resulting in a global winter within 'recorded' history.[[gq2CGVd6nk4dkvUvzYQ3]]
...
chapter_index += 1
section_index = 0
Footnote.create(:slug => "4dkvUvzYQ3", :body => "Volcano Weather: the story of 1816, the year without a summer", :noted => result)
result = Section.create({:name => "Definition",
:body => "<p>A Global winter is a climate event which encompasses the whole planet[[fhD82TW7ErtZquQt8m9p]].
...
@object = result
section_index += 1
Footnote.create(:slug => "tZquQt8m9p", :body => "Volcanic Dry Fogs, Climate Cooling, and Plague Pandemics in Europe and the Middle East", :noted => result)
...
The plagues of Antonine[[pgnuZzH197hb7U098HRM]]  and Cyprian[[pgnuZzH1978YVbfz78Tg]] were the result of the introduction of Smallpox into the Roman army on the borders of the empire resulting in the spread of the disease into the heart land of Rome.
It is believed that both of these epidemic were Smallpox because tests on the measles virus lead some to believe that it did not evolve into it present form until around 1,000 AD[[pgnuZzH197FGeHmgVw8a]].
</p><p>
...
If the 'Winter' is severe enough, plague rears out of Africa traveling along the eastern coast to the Red sea and it connection to the Mediterranean[[pgnuZzH197knKd08KCsZ]].
</p><p>
During the Little Ice Age (1300-1850), the Black  Death was not the only plague to hit Europe[[pgnuZzH1974tkxJdNkBd]].
</p><p>
...
Sent by Apollo via his 'army' of mice[[pgnuZzH197V2XLydGkUe]].
</p><p>
...
Black footed ferrets can also carry the plague fleas without harm[[pgnuZzH1976fA2SCGVeQ]].
</p>",
:slug => "pgnuZzH197",
:position => section_index,
:chapter_id => @chapter.id
...
@object = result
section_index += 1
Footnote.create(:slug => "hb7U098HRM", :body => "165 - 189 AD", :noted => result)
Footnote.create(:slug => "8YVbfz78Tg", :body => "251 - 270 AD", :noted => result)
Footnote.create(:slug => "FGeHmgVw8a", :body => "Wiki reference", :noted => result)
Footnote.create(:slug => "knKd08KCsZ", :body => "Justinian's Flea", :noted => result)
Footnote.create(:slug => "4tkxJdNkBd", :body => "Rats, Lice and History", :noted => result)
Footnote.create(:slug => "V2XLydGkUe", :body => "Iliad", :noted => result)
Footnote.create(:slug => "6fA2SCGVeQ", :body => "Yellow fever, black goddess", :noted => result)
...
:end_year => "",
:body => "<p>Typhoid appears amount the Athenians.</p>",
:slug => "pahwkWzfCn",
:tag_list => [],
:event_types => [  @epidemic ] ,
:citations => [],
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Antonine Plague - First appearance of Smallpox", :start_year => 180)
if result.length == 0
result = HoloceneEvent.create({:name => "Antonine Plague - First appearance of Smallpox",
:end_year => "",
:body => "<p>The plague decimated the army with a 13 to 15 percent loss with the cities suffering similarly while the rural population suffered 7 to 10 percent in loss of life.
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Plague of Cyprian - Second appearance of Smallpox", :start_year => 270)
if result.length == 0
result = HoloceneEvent.create({:name => "Plague of Cyprian - Second appearance of Smallpox",
:end_year => "",
:body => "<p>This plague is credited with having a substantial amount of influence of public view of Christianity as only the Christians were attending the plague victims.</p>",
:slug => "ms5sMs5LPX",
:tag_list => [],
:event_types => [  @cultural ] ,
:citations => [],
...
@object = result
section_index += 1
result = Chapter.create({:name => "The Confusion of Civilizations:  The Babylonian Flood ",
:position =>chapter_index,
:partition => "",
:partition_body => "",
:slug => "RdHDbQmz6H",
...
chapter_index += 1
section_index = 0
result = Section.create({:name => "2354 BC -  Umm al Bini: The confusion of Civilizations ",
...
@object.holocene_events << result
result = Section.create({:name => "8500 BC - Flood of Dardanus ",
:body => "",
:slug => "QQsV6VEaTf",
:position => section_index,
:chapter_id => @chapter.id
...
@object = result
section_index += 1
result = Section.create({:name => "3250 BC -  Noah's Flood ",
:body => "",
:slug => "3jTggN1ctt",
:position => section_index,
:chapter_id => @chapter.id
...
@object = result
section_index += 1
result = HoloceneEvent.where(:name => "Deucalion Deluge ", :start_year => -3250)
if result.length == 0
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Noah's Flood ", :start_year => -3250)
if result.length == 0
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Ogygian Deluge ", :start_year => -1628)
if result.length == 0
...
if result[0].body ==""
res = result[0].update_attributes({:name => "Ogygian Deluge ",
:end_year => "",
:body => "",
:slug => "gqBuFvbJxZ",
:tag_list => [],
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Kaali Meteor Impact ", :start_year => -1500)
if result.length == 0
...
:end_year => "-1500",
:body => "<p>The 'Battle' of Jerico and it subsiquent destruction of all living souls is a curious event in the history of Mosis and the tribes.
...
@object.holocene_events << result
result = Chapter.create({:name => "Comets, plague and survivors - Plague and the issue of war ",
:position =>chapter_index,
:partition => "",
:partition_body => "",
:slug => "Ayzhfndddk",
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Mycenea  ", :start_year => -1200)
if result.length == 0
...
if result[0].body ==""
res = result[0].update_attributes({:name => "Mycenea  ",
:end_year => "-1190",
:body => "",
:slug => "PAYG37QugH",
:tag_list => [],
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Antonine Plague ", :start_year => 165)
if result.length == 0
...
if result[0].body ==""
res = result[0].update_attributes({:name => "Antonine Plague ",
:end_year => "180",
:body => "<p>First appearance of Smallpox.
...
@object.holocene_events << result
result = Section.create({:name => "541 AD - Justian Plague.  Second Occurrence of Plague in Europe ",
:body => "<p>
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Bond 9 ", :start_year => -10900)
if result.length == 0
...
if result[0].body ==""
res = result[0].update_attributes({:name => "Bond 9 ",
:end_year => "",
:body => "",
:slug => "y5E2BzgjGD",
:tag_list => [],
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Possible water damage to the sphinx ", :start_year => -3250)
if result.length == 0
result = HoloceneEvent.create({:name => "Possible water damage to the sphinx ",
:end_year => "",
...
if result[0].body ==""
res = result[0].update_attributes({:name => "Possible water damage to the sphinx ",
:end_year => "",
:body => "<p>The Water erosion hypothesis says that they is evidence of water erosion in the quary from which the Sphinx was created.  It gives no date for the water fall. 
I would content that Noah's flood was the cause of the erosion.
</p>",
...
:event_types => [  @volcanic ] ,
:citations => [ @holoceneeruptions,@stommel1983],
:region => @southeastasia,
...
Confirmed Eruption
Historical Observations
</p><p>This was the first eruption within 'written' history that had the benefit of an extensive amount of information gathered by a wide range of individuals.  The Stommel's in their book[[ZGJUBzVKvnMcB0YGZB0T]] provide a very detailed account of the sequence of events in North America in 1816.  
</p><p>
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Climatic or Thermal Maximum ", :start_year => -8000)
if result.length == 0
...
if result[0].body ==""
res = result[0].update_attributes({:name => "Climatic or Thermal Maximum ",
:end_year => "",
:body => "",
:slug => "tn2TTvRWsC",
:tag_list => [],
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Burkle Crater: Noah's Flood ", :start_year => -3250)
if result.length == 0
...
@object.holocene_events << result
result = HoloceneEvent.where(:name => "Mycenea  ", :start_year => -1240)
if result.length == 0
result = HoloceneEvent.create({:name => "Mycenea  ",
:end_year => "",
:body => "<p>
