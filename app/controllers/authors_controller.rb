class AuthorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @author.save
        ...
        format.html { redirect_back_or_default(polymorphic_path([@object, @author]), notice: 'Author was successfully created.') }
  ...
  def update
    respond_to do |format|
      if @author.update(author_params)
        format.html { redirect_back_or_default(polymorphic_path([@object, @author]), notice: 'Author was successfully updated.') }
  ...
  def destroy
    @author.destroy
    respond_to do |format|
      format.html { redirect_back_or_default(polymorphic_url([@object, :authors]), notice: 'Author was successfully destroyed.') }
