class ActorsController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.turbo_stream { render "shared/index", locals: { object: Actor.new, objects: @actors } }
    end
  end
...
#        format.html { redirect_to actor_url(@actor), notice: "Actor was successfully created." }
        ...
        flash.now[:notice] = "Actor was successfully created."
        format.turbo_stream { render "shared/index", locals: { object: Actor.new, objects: @actors } }
      else
...
#        format.html { redirect_to actor_url(@actor), notice: "Actor was successfully updated." }
        ...
        format.turbo_stream { render "shared/update", locals: { object: @actor, short: @short } }
      else
...
#      format.html { redirect_to book_actors_url(@book), notice: "Actor was successfully destroyed." }
      ...
      flash.now[:now] = "Actor was successfully destroyed."
      format.turbo_stream { render "shared/destroy", locals: { object: Actor.new } }
    end
  end
