class HoloceneEventsController < ApplicationController
  ...
  private
    ...
    def holocene_event_params
      params.require(:holocene_event).permit(:name, :start_year, :end_year, :start_year_uncert, :start_year_mod, :end_year_uncert, :end_year_mod, :body, :region_id, :tag_list, :citations, :user_id, :activated, :seen, :object_id, :object_type,:url, :image, :event_type)
    end
end
