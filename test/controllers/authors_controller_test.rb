...
class AuthorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should not create author" do
    assert_difference('Author.count', 0) do
        post book_authors_path(@book), params: { author: { first_name: "", last_name: @author.last_name, user_id: @user.id } }
    end
  ...
  test "should update author" do
    patch polymorphic_path([@book, @author]), params: { author: { first_name: @author.first_name, last_name: @author.last_name, user_id: @user.id } }
    assert_redirected_to polymorphic_path([@book, @author])
  end

  test "should not update author" do
    patch polymorphic_path([@book, @author]), params: { author: { first_name: "", last_name: @author.last_name, user_id: @user.id } }
    assert_response :success
