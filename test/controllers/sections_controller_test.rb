...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should get move' do
    get polymorphic_url([@section, :move], format: :turbo_stream)

    assert_response :success
  end

  test 'should move section' do
    post polymorphic_url([@section, :moved]),
      params: { new_chapter_id: @sectioned_2.id, chapter_id: @sectioned_1.id }

    assert_response :redirect
    assert_redirected_to polymorphic_url(@section)
  end
  ...
  if 1 == 0
    ...
    test 'should get edit' do
      ...
      assert_select "turbo-frame" do |elements|
        elements.each do |element|
          assert_equal element["id"], (dom_id @section)
        end
      end
      assert_response :success
    end
  ...
  test 'should show section index TS' do
    get polymorphic_url([@sectioned_1, :sections], format: :turbo_stream)
