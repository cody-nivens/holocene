...
class BiblioentriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index" do
    get biblioentries_url
    assert_response :success
  end

  test "should get new" do
    get new_biblioentry_url
    assert_response :success
  end
  ...
  test "should update biblioentry" do
    patch biblioentry_url(@biblioentry), params: { biblioentry: { copyright_holder: @biblioentry.copyright_holder, copyright_year: @biblioentry.copyright_year, name: @biblioentry.name, publisher: @biblioentry.publisher, xreflabel: @biblioentry.xreflabel } }
    assert_redirected_to biblioentry_url(@biblioentry)
  end

  test "should not update biblioentry" do
    patch biblioentry_url(@biblioentry), params: { biblioentry: { copyright_holder: @biblioentry.copyright_holder, copyright_year: @biblioentry.copyright_year, name: "", publisher: @biblioentry.publisher, xreflabel: @biblioentry.xreflabel } }
    assert_response :success
  end
  ...
  test "should destroy biblioentry" do
    ...
    assert_redirected_to biblioentries_url
  end
end
