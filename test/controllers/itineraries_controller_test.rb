...
class ItinerariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post tour_itineraries_url(@tour), params: { itinerary: { name: @itinerary.name, city_id: @itinerary.city_id, position: @itinerary.position, stay: @itinerary.stay, tour_id: @itinerary.tour_id } }
    end
  ...
  test "should not create itinerary" do
    assert_difference('Itinerary.count',0) do
      post tour_itineraries_url(@tour), params: { itinerary: { name: '', city_id: @itinerary.city_id, position: @itinerary.position, stay: @itinerary.stay, tour_id: @itinerary.tour_id } }
    end
  ...
  test "should update itinerary" do
    patch itinerary_url(@itinerary), params: { itinerary: { name: @itinerary.name, city_id: @itinerary.city_id, position: @itinerary.position, stay: @itinerary.stay, tour_id: @itinerary.tour_id } }
    assert_redirected_to itinerary_url(@itinerary)
  end

  test "should not update itinerary" do
    patch itinerary_url(@itinerary), params: { itinerary: { name: '', city_id: @itinerary.city_id, position: @itinerary.position, stay: @itinerary.stay, tour_id: @itinerary.tour_id } }
    assert_response 422
  end
